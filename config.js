...
global.devs = "254705677688" // Developer Conatact
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "254705677688";
...
module.exports = {
  ...
  botname : process.env.BOT_NAME  || "YEGO",
  ownername:process.env.OWNER_NAME|| "It's Yego",
